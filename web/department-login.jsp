            ...
            <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
              <div class="card card-plain mt-8">
                <div class="card-header pb-0 text-left bg-transparent">
                  <h3 class="font-weight-bolder text-info text-gradient">Department Login</h3>
                  ...
                  <center>
                      <%
                                      ...
                                      status=request.getParameter("status");
                                                      if(status.equals("0"))
                                                      {
                                                          out.println("<br><div class='label label-danger' style='font-size: 15px;'>Username/Password Invalid!</div>");
                                                      }
                                      }
                                     catch(Exception e){}
                      %></center>
                ...
                <div class="card-body">
                  <form class="" action="includes/WebService.jsp" method="post" >
                    <input type="hidden" name="action" value="deptlogin"/>
