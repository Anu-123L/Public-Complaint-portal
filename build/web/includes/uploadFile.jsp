...
<%
   ...
   String UPLOAD_DIRECTORY = "/uploads";
    ...
    if((contentType!=null) && (contentType.indexOf("multipart/form-data")>=0)){
        ...
        String saveFile1="/root/Documents/PRO/public-complaint/web/uploads/"+saveFile;
...
//            System.out.print(saveFile1);
            ...
            int res=db.update_delete("update customers set id_proof='"+saveFile+"' where id="+userid);
