...
<body class="g-sidenav-show  bg-gray-100">
  ...
  try{
              ...
              status=request.getParameter("status");
                                  if(status.equals("20"))
                                  {
                                      out.println("<div class='label label-success' style='font-size: 15px;'>Customer deleted successfully!</div><br><br>");
                                  }
           }
  catch(Exception e){}
                  %>
                ...
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="align-middle text-center">
                        <span class="text-secondary text-xs font-weight-bold"><%=rs.getString("gender")%></span>
                      </td>
                      <td class="align-middle">
                        <form class="row login_form" action="includes/WebService.jsp" onsubmit="return confirm('Are you sure?');" method="post" >
                            ...
                            <a href="admin-doctor-edit.jsp?id=<%=rs.getString("id")%>" style="width:auto" class="btn btn-info btn-sm" data-toggle="tooltip" data-original-title="Edit user">
                                Edit
                              </a> 
