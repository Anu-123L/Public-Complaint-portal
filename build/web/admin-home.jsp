...
<body class="g-sidenav-show  bg-gray-100">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg ">
    ...
    <% Database db=new Database();
        int totpat=0;    
        ResultSet respat=db.selectAll("select * from complaints");
        if(respat.next()){
            totpat=respat.getRow();
        }
        int totdoc=0;    
        ResultSet resdoc=db.selectAll("select * from customers");
        if(resdoc.next()){
            totdoc=resdoc.getRow();
        }
        int totdepts=0;
        ResultSet resdept=db.selectAll("select * from departments");
        if(resdept.next()){
            totdepts=resdept.getRow();
        }
